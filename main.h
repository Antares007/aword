...
#define N(argo) void argo(long*o, long **β, long τ, long σ, long ρ, long δ, long ν)
...
#define R(β, ...) (long[]){LEN(__VA_ARGS__), β, __VA_ARGS__, MAPTOSTR(__VA_ARGS__)} + 2
...
#define OB(ρ, ...) β = (long *[]) { β[0], β[1], β[2], β[3], [ρ] = R(β, __VA_ARGS__) }
