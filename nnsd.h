...
#define NNSD35(...) NNSD_ARM(rm, 5, 4, +3, __VA_ARGS__) }
#define NNSD34(...) NNSD_ARM(bm, 4, 4, -3, __VA_ARGS__) NNSD35
#define NNSD33(...) NNSD_ARM(rm, 3, 4, +2, __VA_ARGS__) NNSD34
#define NNSD32(...) NNSD_ARM(lm, 2, 4, -2, __VA_ARGS__) NNSD33
#define NNSD31(...) NNSD_ARM(rm, 1, 4, +1, __VA_ARGS__) NNSD32
#define NNSD30(...) NNSD_ARM(lm, 0, 4, -1, __VA_ARGS__) NNSD31
#define NNSD3(name)                                                            \
  NNSDBody(name, 3) static text_t *name##_hands[3*2] = {NNSD30

#define NNSD23(...) NNSD_ARM(rm, 3, 3, +2, __VA_ARGS__) }
#define NNSD22(...) NNSD_ARM(bm, 2, 3, -2, __VA_ARGS__) NNSD23
#define NNSD21(...) NNSD_ARM(rm, 1, 3, +1, __VA_ARGS__) NNSD22
#define NNSD20(...) NNSD_ARM(lm, 0, 3, -1, __VA_ARGS__) NNSD21
#define NNSD2(name)                                                            \
