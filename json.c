...
Tp(bi_hex, bi_hex_end, //
  ...
  Pos++, bi_hex_tab[So[Pos]](a, b, o, s, d);
}
Tp(tri_hex, hex_end, //
   ...
   ['e'] = bi_hex, ['f'] = bi_hex) {
  Pos++, tri_hex_tab[So[Pos]](a, b, o, s, d);
}
Tp(escape_quad_hex, Got, //
   ...
   ['e'] = tri_hex, ['f'] = tri_hex) {
  Pos++, escape_quad_hex_tab[So[Pos]](a, b, o, s, d);
}
...
Tp(number_digits, God,
   ...
   ['8'] = number_digits, //
   ['9'] = number_digits) {
  Pos++, number_digits_tab[So[Pos]](a, b, o, s, d);
}
...
Tp(number_exponent, Got,         //
   ...
   ['9'] = number_digits) {
  Pos++, number_exponent_tab[So[Pos]](a, b, o, s, d);
}
...
Tp(number_dot, Got,         //
   ...
   ['6'] = number_digits, ['7'] = number_digits, ['8'] = number_digits,
   ['9'] = number_digits, ) {
  Pos++, number_dot_tab[So[Pos]](a, b, o, s, d);
}
Tp(number_zero_start, God, ['.'] = number_dot) {
  Pos++, number_zero_start_tab[So[Pos]](a, b, o, s, d);
}
Tp(number_1to9_start, God, //
  ...
  Pos++, number_1to9_start_tab[So[Pos]](a, b, o, s, d);
}
...
Tp(whitespace, God, [0x09] = whitespace_next, [0x0A] = whitespace_next,
  ...
  whitespace_tab[So[Pos]](a, b, o, s, d);
}
P(value);
P(colon);
...
Tp(object_cross, Got, //
  ...
  object_cross_tab[So[Pos]](a, b, o, s, d);
}
P(object_member) {
...
Tp(object_heart, object_member, //
   ...
   [0x0D] = object_heart,       //
   [0x20] = object_heart) {
  Pos++, object_heart_tab[So[Pos]](a, b, o, s, d);
}
...
Tp(array_cross, Got, //
  ...
  array_cross_tab[So[Pos]](a, b, o, s, d);
}
P(array_member) {
...
Tp(array_heart, array_member, //
   ...
   [0x0D] = array_heart,      //
   [0x20] = array_heart) {
  Pos++, array_heart_tab[So[Pos]](a, b, o, s, d);
}
...
P(value) {
  T(Got, whitespace, Gor);
  value_tab[(unsigned)So[Pos]](a, b, o, s, d);
}
