...
n_t *front_separator, *left_separator;
...
N(locked_left_gate_Red) { back_gateway[2](t, a, b, o, s); }
N(locked_left_gate_Blue) { back_gateway[3](t, a, b, o, s); }
...
G(Purple) {
  ...
  back_gateway[0] = Yellow;
  back_gateway[1] = Green;
  back_gateway[2] = Red;
  back_gateway[3] = Blue;
