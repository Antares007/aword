...
static Color colors[] = {
    {128, 128, 000, 0xff}, // 0 Olive
    {255, 000, 255, 0xff}, // 1 Fuchsia
    {128, 000, 000, 0xff}, // 2 Maroon
    {000, 255, 000, 0xff}, // 3 Lime
    {000, 000, 128, 0xff}, // 4 Navy
    {000, 000, 255, 0xff}, // 5 Blue
    {000, 128, 000, 0xff}, // 6 Green
    {255, 000, 000, 0xff}, // 7 Red
    {128, 000, 128, 0xff}, // 8 Purple
    {255, 255, 000, 0xff}, // 9 Yellow
};
static Font font;
static int debug = 1;
static float zoom = 1;
